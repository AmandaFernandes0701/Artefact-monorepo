      ...
      <FundoDiv>
        <Container>
          ...
          <TaskListContainer role="list">
            {loading && (
              <div
                style={{ display: 'flex', alignItems: 'center', gap: '10px', alignSelf: 'center' }}
                role="status"
              >
          ...
          <Modal isOpen={isTaskModalOpen} onRequestClose={closeTaskModal}>
            <ModalContainer role="dialog" aria-modal="true" aria-labelledby="modal-title">
              <ModalHeader>
                ...
                <ModalCloseButton onClick={closeTaskModal} aria-label="Fechar Modal">
                  ×
                </ModalCloseButton>
              </ModalHeader>
              <ModalBody>
          ...
          <Modal isOpen={isDeleteModalOpen} onRequestClose={closeDeleteModal}>
            <ModalContainer role="dialog" aria-modal="true" aria-labelledby="delete-modal-title">
              <ModalHeader>
                ...
                <ModalCloseButton onClick={closeDeleteModal} aria-label="Fechar Modal">
                  ×
                </ModalCloseButton>
              </ModalHeader>
              <ModalBody>
